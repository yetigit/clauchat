...
pub fn render_header(
    ...
    config: &mut Config,
    on_api_key_change: impl FnOnce(&mut Config, String),
){
    ui.horizontal(|ui| {
        ui.heading("ClauChat");
        ui.with_layout(
        ...
        .show(ui, |ui|{
                ...
                ui.horizontal(|ui|{
                    ...
                    if api_key_response.changed() {
                        ...
                        on_api_key_change(config, new_key);
                    }
                ...
                ui.horizontal(|ui|{
                    ...
                    if ui.selectable_label(matches!(current_theme, Theme::Light), "Light").clicked() {
                        config.theme = Theme::Light;
                    }

                    if ui.selectable_label(matches!(current_theme, Theme::Dark), "Dark").clicked() {
                        config.theme = Theme::Dark;
                    }

                    if ui.selectable_label(matches!(current_theme, Theme::System), "System").clicked() {
...
pub fn render_input_area(
    ...
    input: &mut String,
    is_sending: bool,
    on_send: impl FnOnce(&mut dyn std::any::Any),
